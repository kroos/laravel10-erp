@extends('layouts.app')
@section('content')
<div class="container row rounded align-items-start justify-content-center border border-primary">
	...
	<div class="container row">
		...
		<div class="m-2 border border-primary" id="wrapper">
		</div>
