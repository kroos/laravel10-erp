						$('#wrapperday').append(
							...
							'<div class="col-sm-8 mb-2 removehalfleave " id="halfleave">' +
								'<div class="form-check form-check-inline" id="removeleavehalf">' +
									'<input type="radio" name="leave_cat" value="1" id="radio1" class="form-check-input m-2" disabled="disabled">' +
									'{{ Form::label('radio1', 'Full Day Off', ['class' => 'form-check-label m-2']) }}' +
								'</div>' +
								'<div class="form-check form-check-inline" id="appendleavehalf">' +
									'<input type="radio" name="leave_cat" value="2" id="radio2" class="form-check-input m-2" checked="checked">' +
