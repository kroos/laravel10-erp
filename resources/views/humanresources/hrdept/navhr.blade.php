...
<!-- 		<li><a class="dropdown-item" href="#">Something else here</a></li>
	...
	<li class="nav-item dropdown">
		...
		<ul class="dropdown-menu">
			...
			<li><a class="dropdown-item btn btn-sm btn-outline-secondary" href="{{ route('rleave.index') }}"><i class="fa-solid fa-person-walking-arrow-right fa-beat"></i> Replacement Leave List</a></li>
			<li><a class="dropdown-item btn btn-sm btn-outline-secondary" href="{{ route('rleave.create') }}"><i class="fa-solid fa-person-walking-arrow-right fa-beat"></i> Add Replacement Leave</a></li>
