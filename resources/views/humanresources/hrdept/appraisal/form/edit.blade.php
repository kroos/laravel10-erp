...
@section('content')
  ...
  <div class="container">
    ...
    @foreach ($appraisals as $appraisal)
      ...
      @foreach ($sections as $section)
        ...
        @if (strpos($section->section, '1') !== false)
          <table width="100%">
            <tr>
              <td>
                ...
                <button type="button" id="myButton" data-bs-toggle="modal" data-bs-target="#section{{ $section->id }}"
                  data-id="{{ $section->id }}">
                  {!! $section->section !!}
                </button>

                <!-- POP UP SECTION -->
                <div class="modal fade" id="section{{ $section->id }}" aria-labelledby="sectionlabel{{ $section->id }}"
                  aria-hidden="true">
                      ...
                      <div class="modal-body align-items-start justify-content-center">
                        <div class="row mb-1">
                          <div class="col-sm-2 {{ $errors->has('section_sort') ? 'has-error' : '' }}">
                            <input type="number" name="section_sort{{ $section->id }}"
                              id="section_sort{{ $section->id }}" class="form-control form-control-sm"
                              placeholder="Sort" value="{{ $section->sort }}"
                              oninput="this.value = (this.value < 1) ? 1 : this.value;">
                          </div>
                        </div>
                        <div class="row mb-1">
                          <div class="mb-1 {{ $errors->has('section_text') ? 'has-error' : '' }}">
                            <textarea name="section_text{{ $section->id }}" id="section_text{{ $section->id }}"
                              class="form-control form-control-sm">{!! $section->section !!}</textarea>
                          </div>
                        </div>
                      </div>
                ...
                <script>
                  ...
                  (function($) {
                    $(document).ready(function() {
                      var no = <?php echo json_encode($section->id); ?>;

                      CKEDITOR.replace('section_text' + no, {
                        toolbar: [{
                            name: 'clipboard',
            ...
            @foreach ($section_subs as $section_sub)
              ...
              <tr>
                ...
                <td colspan="3" class="td-border-right">
                  ...
                  <button type="button" id="myButton" data-bs-toggle="modal"
                    data-bs-target="#section_sub{{ $section_sub->id }}" data-id="{{ $section_sub->id }}">
                    {!! $section_sub->section_sub !!}
                  </button>

                  <!-- POP UP SECTION SUB -->
                  <div class="modal fade" id="section_sub{{ $section_sub->id }}"
                    aria-labelledby="sectionsublabel{{ $section_sub->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                        ...
                        <div class="modal-body align-items-start justify-content-center">
                          <div class="row mb-1">
                            <div class="col-sm-2 {{ $errors->has('section_sub_sort') ? 'has-error' : '' }}">
                              <input type="number" name="section_sub_sort{{ $section_sub->id }}"
                                id="section_sub_sort{{ $section_sub->id }}" class="form-control form-control-sm"
                                placeholder="Sort" value="{{ $section_sub->sort }}"
                                oninput="this.value = (this.value < 1) ? 1 : this.value;">
                            </div>
                          </div>
                          <div class="row mb-1">
                            <div class="mb-1 {{ $errors->has('section_sub_text') ? 'has-error' : '' }}">
                              <textarea name="section_sub_text{{ $section_sub->id }}" id="section_sub_text{{ $section_sub->id }}"
                                class="form-control form-control-sm">{!! $section_sub->section_sub !!}</textarea>
                            </div>
                          </div>
                        </div>
                        <div class="modal-footer">
                  ...
                  <script>
                    ...
                    (function($) {
                      $(document).ready(function() {
                        var no = <?php echo json_encode($section_sub->id); ?>;

                        CKEDITOR.replace('section_sub_text' + no, {
                          toolbar: [{
                              name: 'clipboard',
                              items: ['Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo']
                            },
              ...
              @foreach ($main_questions as $main_question)
                ...
                <tr>
                  ...
                  <td colspan="3" class="td-border-right">
                    ...
                    <button type="button" id="myButton" data-bs-toggle="modal"
                      data-bs-target="#main_question{{ $main_question->id }}" data-id="{{ $main_question->id }}">
                      {!! $main_question->main_question !!}
                    </button>

                    <!-- POP UP MAIN QUESTION -->
                    <div class="modal fade" id="main_question{{ $main_question->id }}"
                      aria-labelledby="mainquestionlabel{{ $main_question->id }}" aria-hidden="true">
                      <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                          ...
                          <div class="modal-body align-items-start justify-content-center">
                            <div class="row mb-1">
                              <div class="col-sm-2 {{ $errors->has('main_question_sort') ? 'has-error' : '' }}">
                                <input type="number" name="main_question_sort{{ $main_question->id }}"
                                  id="main_question_sort{{ $main_question->id }}" class="form-control form-control-sm"
                                  placeholder="Sort" value="{{ $main_question->sort }}"
                                  oninput="this.value = (this.value < 1) ? 1 : this.value;">
                              </div>
                              <div class="col-sm-2 {{ $errors->has('main_question_mark') ? 'has-error' : '' }}">
                                <input type="number" name="main_question_mark{{ $main_question->id }}"
                                  id="main_question_mark{{ $main_question->id }}" class="form-control form-control-sm"
                                  placeholder="Mark" value="{{ $main_question->mark }}"
                                  oninput="this.value = (this.value < 1) ? 1 : this.value;">
                              </div>
                            </div>
                            <div class="row mb-1">
                              <div class="mb-1 {{ $errors->has('main_question_text') ? 'has-error' : '' }}">
                                <textarea name="main_question_text{{ $main_question->id }}" id="main_question_text{{ $main_question->id }}"
                                  class="form-control form-control-sm">{!! $main_question->main_question !!}</textarea>
                              </div>
                            </div>
                          </div>
                          <div class="modal-footer">
                    ...
                    <script>
                      ...
                      (function($) {
                        $(document).ready(function() {
                          var no = <?php echo json_encode($main_question->id); ?>;

                          CKEDITOR.replace('main_question_text' + no, {
                            toolbar: [{
                                name: 'clipboard',
                                items: ['Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo']
                              },
                ...
                @foreach ($questions as $question)
                  <tr>
                    ...
                    <td class="td-border-right">
                      ...
                      <button type="button" id="myButton" data-bs-toggle="modal"
                        data-bs-target="#question{{ $question->id }}" data-id="{{ $question->id }}">
                        {!! $question->question !!}
                      </button>
                            ...
                            <div class="modal-body align-items-start justify-content-center">
                              <div class="row mb-1">
                                <div class="col-sm-2 {{ $errors->has('question_sort') ? 'has-error' : '' }}">
                                  <input type="number" name="question_sort{{ $question->id }}"
                                    id="question_sort{{ $question->id }}" class="form-control form-control-sm"
                                    placeholder="Sort" value="{{ $question->sort }}"
                                    oninput="this.value = (this.value < 1) ? 1 : this.value;">
                                </div>
                                <div class="col-sm-2 {{ $errors->has('question_mark') ? 'has-error' : '' }}">
                                  <input type="number" name="question_mark{{ $question->id }}"
                                    id="question_mark{{ $question->id }}" class="form-control form-control-sm"
                                    placeholder="Mark" value="{{ $question->mark }}"
                                    oninput="this.value = (this.value < 1) ? 1 : this.value;">
                                </div>
                              </div>
                              <div class="row mb-1">
                                <div class="mb-1 {{ $errors->has('question_text') ? 'has-error' : '' }}">
                                  <textarea name="question_text{{ $question->id }}" id="question_text{{ $question->id }}"
                                    class="form-control form-control-sm">{!! $question->question !!}</textarea>
                                </div>
                              </div>
                            </div>
                            <div class="modal-footer">
                      ...
                      <script>
                        ...
                        (function($) {
                          $(document).ready(function() {
                            var no = <?php echo json_encode($question->id); ?>;

                            CKEDITOR.replace('question_text' + no, {
                              toolbar: [{
                                  name: 'clipboard',
                                  items: ['Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo']
                                },
                    ...
                    <div class="row mb-3">
                      <div style="width: 10%">
                        <button type="button" data-bs-toggle="modal"
                          data-bs-target="#question_add{{ $main_question->id }}" data-id="{{ $main_question->id }}"
                      ...
                      <!-- POP UP QUESTION -->
                      <div class="modal fade" id="question_add{{ $main_question->id }}"
                        aria-labelledby="questionlabeladd{{ $main_question->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                            ...
                            <div class="modal-body align-items-start justify-content-center">
                              <div class="row mb-1">
                                <div class="col-sm-2 {{ $errors->has('question_sort_add') ? 'has-error' : '' }}">
                                  <input type="number" name="question_sort_add{{ $main_question->id }}"
                                    id="question_sort_add{{ $main_question->id }}" class="form-control form-control-sm"
                                    placeholder="Sort" oninput="this.value = (this.value < 1) ? 1 : this.value;">
                                </div>
                                <div class="col-sm-2 {{ $errors->has('question_mark_add') ? 'has-error' : '' }}">
                                  <input type="number" name="question_mark_add{{ $main_question->id }}"
                                    id="question_mark_add{{ $main_question->id }}" class="form-control form-control-sm"
                                    placeholder="Mark" oninput="this.value = (this.value < 1) ? 1 : this.value;">
                                </div>
                              </div>
                              <div class="row mb-1">
                                <div class="mb-1 {{ $errors->has('question_text_add') ? 'has-error' : '' }}">
                                  <textarea name="question_text_add{{ $main_question->id }}" id="question_text_add{{ $main_question->id }}"
                      ...
                      <script>
                        ...
                        (function($) {
                          $(document).ready(function() {
                            ...
                            CKEDITOR.replace('question_text_add' + no, {
                              toolbar: [{
                                  name: 'clipboard',
                                  items: ['Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo']
                                },
              ...
              <tr>
                ...
                <td class="td-border-right" colspan="3">
                  <div class="row mb-3">
                    <div style="width: 10%">
                      <button type="button" data-bs-toggle="modal"
                        data-bs-target="#main_question_add{{ $section_sub->id }}" data-id="{{ $section_sub->id }}"
                        class="col-auto btn btn-sm btn-outline-secondary">
                    ...
                    <!-- POP UP MAIN QUESTION -->
                    <div class="modal fade" id="main_question_add{{ $section_sub->id }}"
                      aria-labelledby="mainquestionlabeladd{{ $section_sub->id }}" aria-hidden="true">
                      <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                          ...
                          <div class="modal-body align-items-start justify-content-center">
                            <div class="row mb-1">
                              <div class="col-sm-2 {{ $errors->has('main_question_sort_add') ? 'has-error' : '' }}">
                                <input type="number" name="main_question_sort_add{{ $section_sub->id }}"
                                  id="main_question_sort_add{{ $section_sub->id }}"
                                  class="form-control form-control-sm" placeholder="Sort"
                                  oninput="this.value = (this.value < 1) ? 1 : this.value;">
                              </div>
                              <div class="col-sm-2 {{ $errors->has('main_question_mark_add') ? 'has-error' : '' }}">
                                <input type="number" name="main_question_mark_add{{ $section_sub->id }}"
                                  id="main_question_mark_add{{ $section_sub->id }}"
                                  class="form-control form-control-sm" placeholder="Mark"
                                  oninput="this.value = (this.value < 1) ? 1 : this.value;">
                              </div>
                            </div>
                            <div class="row mb-1">
                              <div class="mb-1 {{ $errors->has('main_question_text_add') ? 'has-error' : '' }}">
                                <textarea name="main_question_text_add{{ $section_sub->id }}" id="main_question_text_add{{ $section_sub->id }}"
                                  class="form-control form-control-sm"></textarea>
                              </div>
                            </div>
                          </div>
                    ...
                    <script>
                      ...
                      (function($) {
                        $(document).ready(function() {
                          ...
                          CKEDITOR.replace('main_question_text_add' + no, {
                            toolbar: [{
                                name: 'clipboard',
                                items: ['Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo']
                              },
          ...
          <div class="row mb-3">
            <div style="width: 10%">
              <button type="button" data-bs-toggle="modal" data-bs-target="#section_sub_add{{ $section->id }}"
                data-id="{{ $section->id }}" class="col-auto btn btn-sm btn-outline-secondary">
                P2 <i class="fas fa-plus" aria-hidden="true"></i>
              </button>
            </div>

            <!-- POP UP SECTION SUB -->
            <div class="modal fade" id="section_sub_add{{ $section->id }}"
              aria-labelledby="sectionsublabeladd{{ $section->id }}" aria-hidden="true">
              <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                  ...
                  <div class="modal-body align-items-start justify-content-center">
                    <div class="row mb-1">
                      <div class="col-sm-2 {{ $errors->has('section_sub_sort_add') ? 'has-error' : '' }}">
                        <input type="number" name="section_sub_sort_add{{ $section->id }}"
                          id="section_sub_sort_add{{ $section->id }}" class="form-control form-control-sm"
                          placeholder="Sort" oninput="this.value = (this.value < 1) ? 1 : this.value;">
                      </div>
                    </div>
                    <div class="row mb-1">
                      <div class="mb-1 {{ $errors->has('section_sub_text_add') ? 'has-error' : '' }}">
                        <textarea name="section_sub_text_add{{ $section->id }}" id="section_sub_text_add{{ $section->id }}"
                          class="form-control form-control-sm"></textarea>
                      </div>
                    </div>
                  </div>
            ...
            <script>
              ...
              (function($) {
                $(document).ready(function() {
                  ...
                  CKEDITOR.replace('section_sub_text_add' + no, {
                    toolbar: [{
                        name: 'clipboard',
                        items: ['Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo']
                      },
        ...
        @if (strpos($section->section, '2') !== false)
          <table width="100%">
            <tr>
              <td>
                <button type="button" id="myButton" data-bs-toggle="modal"
                  data-bs-target="#section{{ $section->id }}" data-id="{{ $section->id }}">
                  {!! $section->section !!}
                </button>

                <!-- POP UP SECTION -->
                <div class="modal fade" id="section{{ $section->id }}"
                  aria-labelledby="sectionlabel{{ $section->id }}" aria-hidden="true">
                  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    {!! Form::model($section, [
                        'route' => ['appraisalform.update', $section->id],
                        'method' => 'PATCH',
    ...
    <div class="row mb-3">
      <div style="width: 10%">
        <button type="button" data-bs-toggle="modal" data-bs-target="#section_add"
          class="col-auto btn btn-sm btn-outline-danger">
            ...
            <div class="modal-body align-items-start justify-content-center">
              <div class="row mb-1">
                <div class="col-sm-2 {{ $errors->has('section_sort_add') ? 'has-error' : '' }}">
                  <input type="number" name="section_sort_add" id="section_sort_add"
                    class="form-control form-control-sm" placeholder="Sort"
                    oninput="this.value = (this.value < 1) ? 1 : this.value;">
                </div>
              </div>
